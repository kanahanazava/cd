...
3) Exit
Enter your choice: 1
Enter number 1 rules of grammar: E->E+E

1) Insert Production Rules
2) Show Grammar
3) Exit
Enter your choice: 1
Enter number 2 rules of grammar: E->E*E

1) Insert Production Rules
2) Show Grammar
3) Exit
Enter your choice: 1
Enter number 3 rules of grammar: E->(E)

1) Insert Production Rules
2) Show Grammar
3) Exit
Enter your choice: 1
Enter number 4 rules of grammar: E->id
...
Grammar
Starting symbol is: E
Non-terminal symbol is: E  
Terminal symbol is: +  *  (  )  id  
Production rules: E->E+E  E->E*E  E->(E)  E->id
...
Enter string for parsing: id + id * id
...
E                       id + id * id            Shift: E
E id                    + id * id               Shift: id
E id +                  id * id                 Reduced: id
E id                    * id                    Shift: +
E id +                  * id                    Shift: id
E id + id               * id                    Reduced: id
E id + E                * id                    Reduced: E+E
E id + E *              id                    Shift: *
E id + E * id           $                      Reduced: id
E id + E * E            $                      Reduced: E*E
E id + E                $                      Reduced: E+E
E id                    $                      Parsing successfully
*/